      ...
      <div className="relative w-full overflow-x-scroll ">
        ...
        >
          {FeaturedHostels.map((hostel: Hostel) => (
           ...
           <div className=" relative flex h-full  lg:min-w-[250px]    
             flex-col gap-4 pb-4 bg-white drop-shadow-lg min-h-[350px]">
          <div className='absolute w-full h-full bg-black/20 bottom-0 z-10'></div>
        <div className="absolute  h-full w-full group-hover:opacity-75">
          <Image
            src={'/hero1.jpg'}
            alt={'name'}
            width={500}
